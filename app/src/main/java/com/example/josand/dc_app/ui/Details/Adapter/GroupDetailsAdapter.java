...
public class GroupDetailsAdapter extends BaseAdapter implements Filterable{

    private CustomFilter customFilter;
    private ArrayList<Grupo> list,filterList;
    private Context mContext;

    public GroupDetailsAdapter(ArrayList<Grupo> list, Context mContext) {
        this.list = list;
    ...
    class CustomFilter extends Filter{
        ...
        protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
            list = (ArrayList<Grupo>) filterResults.values;
